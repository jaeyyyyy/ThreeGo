            ...
            <div class="row row-cols-1 row-cols-md-4 g-4">
                ...
                <div class="col">
                    ...
                    <div class="card border-0">
                        <img src="../../../proj/resources/assets/img/mainimg/seoul2.jpg" class="card-img-top rounded"
                             alt="서울">
                ...
                <div class="col">
                    ...
                    <div class="card border-0">
                        <img src="../../../proj/resources/assets/img/mainimg/busan.png" class="card-img-top rounded"
                             alt="부산">
                        <div class="card-img-overlay cardgradient">
                ...
                <div class="col">
                    ...
                    <div class="card border-0">
                        <img src="../../../proj/resources/assets/img/mainimg/jeju.jpg" class="card-img-top rounded"
                             alt="제주">
                        <div class="card-img-overlay cardgradient">
                ...
                <div class="col">
                    ...
                    <div class="card border-0">
                        <img src="../../../proj/resources/assets/img/mainimg/daejeon.jpg" class="card-img-top rounded"
                             alt="대전">
                        <div class="card-img-overlay cardgradient">
                ...
                <div class="col">
                    ...
                    <div class="card border-0">
                        <img src="../../../proj/resources/assets/img/mainimg/daegu.png" class="card-img-top rounded"
                             alt="대구">
                        <div class="card-img-overlay cardgradient">
                ...
                <div class="col">
                    ...
                    <div class="card border-0">
                        <img src="../../../proj/resources/assets/img/mainimg/kunggi.jpg" class="card-img-top rounded"
                             alt="경기도 수원">
                        <div class="card-img-overlay cardgradient">
                ...
                <div class="col">
                    ...
                    <div class="card border-0">
                        <img src="../../../proj/resources/assets/img/mainimg/gwangju.jpg" class="card-img-top rounded"
                             alt="광주">
                        <div class="card-img-overlay cardgradient">
